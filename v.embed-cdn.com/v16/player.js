!(function (t) {
  ...
  function (t, e, n) {
    ...
    if (n(7)) {
      var i = n(29),
        ...
        Bt = function (t, e, n) {
          return !(Ft(t, (e = b(e, !0))) && k(n) && _(n, "value")) ||
            _(n, "get") ||
            _(n, "set") ||
            n.configurable ||
        ...
        (t.exports = function (t, e, n, r) {
          ...
          b
            ? ((h = n(function (t, n, r, i) {
                ...
                if (k(n)) {
                  if (
                    ...
                    return _t in n ? Ot(h, n) : Tt.call(h, n);
                  (o = n), (p = Ct(r, e));
                  var v = n.byteLength;
                  if (void 0 === i) {
                ...
                for (
                  d(t, "_d", { b: o, o: p, l: a, e: s, v: new Y(o) });
                  l < s;
            ...
            : (a(function () {
              ...
              $(
                m !== Function.prototype ? M(v).concat(M(m)) : M(v),
                function (t) {
                  t in h || d(h, t, v[t]);
                }
              ),
      ...
      f = (t.exports = function (t, e, n, f, p) {
        ...
        if (o(y)) {
          for (d = s(t.length); d > b; b++)
            if ((g = e ? m(a((h = t[b]))[0], h[1]) : m(t[b])) === u || g === l)
              return g;
        } else
  ...
  function (t, e, n) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      (e.getElapsedTime = l),
      (e.enable = f),
      (e.enableConsole = function () {
        p("CONSOLE ENABLED", !0),
          ((a = document.createElement("div")).style.wordWrap = "break-word"),
          (a.style.width = "100%"),
          document.body.appendChild(a),
          (0, i.default)(
            "http://192.168.1.143:8888/target/target-script-min.js#anonymous",
            function () {
              p("Weinre loaded", !0);
            }
          );
    ...
    function p(t, e, n) {
      ...
      (n = n || "transparent"),
        ...
        a && (a.innerHTML = r + "<br/>" + a.innerHTML);
    }
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      ...
      (e.isPreIOS10 = function () {
        if (r()) {
          ...
          if (e[0] <= 9)
            return console.log("LESS THAN IOS 10. Don't show ad"), !0;
        }
        return !1;
      }),
  ...
  function (t, e, n) {
    ...
    function L(t, e, n) {
      ...
      for (
        (t = A(t)) != t || t === x
          ...
          : ((r = E(O(t) / D)),
            t * (o = M(2, -r)) < 1 && (r--, (o *= 2)),
            (t += r + u >= 1 ? l / o : l * M(2, 1 - u)) * o >= 2 &&
              (r++, (o /= 2)),
            r + u >= c
              ? ((i = 0), (r = c))
              : r + u >= 1
              ? ((i = (t * o - 1) * M(2, e)), (r += u))
              : ((i = t * M(2, u - 1) * M(2, e)), (r = 0)));
        e >= 8;
        a[f++] = 255 & i, i /= 256, e -= 8
      );
    ...
    function q(t, e, n, r, i, o) {
      ...
      for (var s = t[T]._b, c = a + t[P], u = r(+i), l = 0; l < e; l++)
        s[c + l] = u[o ? l : e - l - 1];
    }
    if (a.ABV) {
      if (
  ...
  function (t, e, n) {
    ...
    (o = function () {
      ...
      function h(e, n, r) {
        ...
        function m() {
          if (!--g)
            for (var t in ((c[s] = 1), a && a(), l))
              p(t.split("|"), y) && !d(l[t], y) && (l[t] = []);
        }
        return (
          setTimeout(function () {
            d(e, function e(n, r) {
        ...
        (h.ready = function (t, e, n) {
          ...
          return (
            ...
            p(t, function (t) {
              ...
              ? e()
              : ((r = t.join("|")), (l[r] = l[r] || []), l[r][o](e), n && n(i)),
            h
          );
        }),
        (h.done = function (t) {
  ...
  function (t, e, n) {
    ...
    n(7) &&
      "g" != /./g.flags &&
      n(8).f(RegExp.prototype, "flags", { configurable: !0, get: n(52) });
  },
  function (t, e, n) {
    "use strict";
    t.exports = function (t) {
          ...
          typeof (r = function () {
            ...
            function u() {
              ...
              for (e = 0; e < r.length; e++)
                o && i ? t.test(r[e].readyState) && h.push(r[e]) : h.push(r[e]);
              if (((l = new Error()), s && (f = l.stack), !f && c))
                try {
                  throw l;
                } catch (t) {
                  f = t.stack;
                    ...
                    return (
                      ...
                      "string" == typeof e &&
                        ...
                        r &&
                          r[1] &&
                          (n > 0
                            ? ((i = e.slice(e.indexOf(r[0]) + r[0].length)),
                              (o = t(i, n - 1)))
                            : (o = r[1]))),
                      o
                    );
  ...
  function (t, e, n) {
    "use strict";
    (function (t) {
      if ((n(135), n(332), n(334), t._babelPolyfill))
  ...
  function (t, e, n) {
    ...
    var r =
      ...
      X = function (t, e) {
        b(t);
        for (var n, r = y((e = k(e))), i = 0, o = r.length; o > i; )
          $(t, (n = r[i++]), e[n]);
        return t;
      },
      Q = function (t) {
      ...
      tt = function (t) {
        for (var e, n = P(k(t)), r = [], i = 0; n.length > i; )
          o(B, (e = n[i++])) || e == N || e == u || r.push(e);
        return r;
      },
      et = function (t) {
        for (
          var e, n = t === W, r = P(n ? H : k(t)), i = [], a = 0;
          r.length > a;
    ...
    q ||
      ...
      (n(51).f = Q),
      (E.f = et),
      a && !n(29) && c(W, "propertyIsEnumerable", Q, !0),
      (v.f = function (t) {
        return K(h(t));
      })),
    ...
    s(s.S + s.F * at, "Object", {
      ...
      L.prototype[V] || n(11)(L.prototype, V, L.prototype.valueOf),
      p(L, "Symbol"),
      p(Math, "Math", !0),
      p(i.JSON, "JSON", !0);
  },
  ...
  function (t, e, n) {
    "use strict";
    var r = n(0);
    r(r.S + r.F * !n(7), "Object", { defineProperties: n(100) });
  },
  function (t, e, n) {
    "use strict";
    var r = n(15),
        ...
        from: function (t) {
          ...
          if (
            ...
            for (f = m.call(p), n = new d(); !(i = f.next()).done; y++)
              u(n, y, g ? a(f, v, [i.value, y], !0) : i.value);
          return (n.length = y), n;
        },
      }
    );
  ...
  function (t, e, n) {
    "use strict";
    var r = n(0);
    r(r.P, "Array", { copyWithin: n(114) }), n(31)("copyWithin");
  },
  function (t, e, n) {
    "use strict";
    var r = n(0);
    r(r.P, "Array", { fill: n(87) }), n(31)("fill");
  },
  function (t, e, n) {
    "use strict";
    var r = n(0),
        ...
        function (t, e) {
          ...
          for (var _, w = "", k = 0, S = 0; S < m.length; S++) {
            ...
            for (
              ...
              A.push(void 0 === (_ = b[M]) ? _ : String(_));
            var E = b.groups;
            if (d) {
        ...
        [
          ...
          function (t, e) {
            ...
            for (var _ = 0, w = 0, k = []; w < p.length; ) {
              ...
              if (
                null === x ||
                (S = f(s(m.lastIndex + (d ? 0 : w)), p.length)) === _
              )
                w = a(p, w, g);
              else {
  ...
  function (t, e, n) {
    "use strict";
    var r = n(0);
    r(r.G + r.W + r.F * !n(64).ABV, { DataView: n(94).DataView });
  },
  function (t, e, n) {
    "use strict";
  ...
  function (t, e, n) {
    "use strict";
    var r = n(0);
    r(r.P + r.R, "Map", { toJSON: n(130)("Map") });
  },
  function (t, e, n) {
    "use strict";
    var r = n(0);
    r(r.P + r.R, "Set", { toJSON: n(130)("Set") });
  },
  function (t, e, n) {
    "use strict";
    n(66)("Map");
    ...
    (function (t, e) {
      ...
      !(function (t) {
        ...
        if (f) l && (e.exports = f);
          ...
          (x.prototype = _.constructor = C),
            (C.constructor = x),
            (C[u] = x.displayName = "GeneratorFunction"),
  ...
  function (t, e, n) {
    ...
    var o = "production",
      ...
      s = "//v.embedcdn.com/",
      c = (0, ((r = i) && r.__esModule ? r : { default: r }).default)(),
      u = c.src
        .replace("ads.js", "")
        .replace("embed.js", "")
        .replace("player.js", "");
    -1 !== c.src.search("staging.") &&
      ((o = "staging"),
      (a = "wss://chat-staging.streamable.com"),
      (s = "//staging.embedcdn.com/")),
      (-1 === c.src.search("localhost") && -1 === c.src.search(".local:")) ||
        ((o = "development"),
        (a = "ws://localhost:8080"),
        (s = "//staging.embedcdn.com/"),
        (u = "http://localhost:8000/lib/")),
      (e.default = { env: o, socket: a, dataHost: s, assetsHost: u }),
      (t.exports = e.default);
  },
  function (t, e, n) {
    "use strict";
      ...
      (s.prototype.removeListener = function (t, e, n, r) {
        ...
        if (s.fn)
          ...
          for (var c = 0, u = [], l = s.length; c < l; c++)
            (s[c].fn !== e || (r && !s[c].once) || (n && s[c].context !== n)) &&
              u.push(s[c]);
          u.length
  ...
  function (t, e, n) {
    ...
    (e.setup = function () {
      if (
        ...
        "[object Array]" ===
          Object.prototype.toString.call(window.STM_TRANSPORT))
      ) {
        var t = window.STM_TRANSPORT.splice(0);
        window.STM_TRANSPORT = new f(t);
      }
      return (
        (window.STM_TRANSPORT = window.STM_TRANSPORT || new f()),
        window.STM_TRANSPORT
      );
    }),
      (e.get = p),
      (e.requestAd = function (t, e) {
        var n = p(),
    ...
    var u = [
      ...
      f = (function () {
        function t(e) {
          ...
          var n = this;
          (this.emitter_ = new i.default()),
            (this.queue_ = e),
            window.STM_PRELOADED_SOCKET
              ? ((0, a.log)("Preloaded websocket"),
                (this.ws_ = window.STM_PRELOADED_SOCKET))
              : "WebSocket" in window &&
                ((0, a.log)("Creating websocket"),
                (this.ws_ = new WebSocket(o.default.socket))),
            this.ws_ &&
              (this.setup(),
              setTimeout(function () {
                n.destroy();
          ...
          r(t, [
            {
              ...
              value: function () {
                ...
                this.addMessageListener("ping", function () {
                  t.ws_.send(JSON.stringify({ type: "pong" }));
                }),
                  this.addMessageListener("handshake", function (t) {
                    var e = t.session;
                    "development" === o.default.env
                      ? s.default.set("session", e, { expires: 3e7 })
                  ...
                  1 === this.ws_.readyState
                    ? ((0, a.log)("Websocket open"),
                      this.processQueue(),
                      this.ws_.send(JSON.stringify({ type: "handshake" })))
                    : (this.ws_.onopen = function () {
                        (0, a.log)("Websocket open"),
                          t.processQueue(),
                          t.ws_.send(JSON.stringify({ type: "handshake" }));
                      }),
                  (this.ws_.onmessage = function (e) {
                    var n = JSON.parse(e.data);
                    n
                      ? t.emitter_.emit(n.type, n.payload)
                      : (0, a.log)("Bad message received: " + e.data);
                  });
              },
            },
            {
              ...
              value: function () {
                for (; this.queue_.length; ) {
                  ...
                  if (!t) break;
                  (0, a.log)("Pulled from queue: " + JSON.stringify(t)),
                    this.ws_.send(JSON.stringify(t));
                }
              },
            },
            {
            ...
            },
            {
              key: "push",
              value: function (t) {
                this.ws_ && 1 === this.ws_.readyState
                  ? this.ws_.send(JSON.stringify(t))
                  : ((0, a.log)("Queueing send"), this.queue_.push(t));
              },
            },
          ]),
          t
  ...
  function (t, e, n) {
    ...
    var r,
      ...
      l = n(133);
    for (
      var f = (0, ((r = l) && r.__esModule ? r : { default: r }).default)(),
        p = {},
        d = /^data\-(.+)$/,
        h = /^data\-mobile\-(.+)$/,
        v = 0;
      v < f.attributes.length;
      v++
    ) {
    ...
    if (
      ((p.debug || -1 !== (0, o.getPageURL)().indexOf("STM_DEBUG_MODE")) &&
        ((0, c.enable)(), (0, c.log)("Loading scripts")),
      !f)
    )
      throw ((0, c.log)("Script not found", !0), new Error("Script not found"));
    if (
      f.src &&
      -1 === f.src.indexOf("/ads.js") &&
      -1 === f.src.indexOf("/player.js") &&
      ((0, c.log)("Unrecognized script", !0), !p.debug)
    )
      throw new Error("Unrecognized script");
    if (
      ("undefined" != typeof $sf && $sf.ext && (0, c.log)("SafeFrame enabled"),
      (p.scriptsrc = f.src.replace("https://", "").replace("http://", "")),
      p.scriptsrc.split("?").length &&
        (p.scriptsrc = p.scriptsrc.split("?")[0]),
      (p.muted = (0, u.processBooleanAttribute)(p, "muted", !0)),
      (p.unmuteonhover = (0, u.processBooleanAttribute)(
        p,
        "unmuteonhover",
        !0
      )),
      (p.muteonclick = (0, u.processBooleanAttribute)(p, "muteonclick", !1)),
      (p.autoplay = (0, u.processBooleanAttribute)(p, "autoplay", !0)),
      (p.loop = (0, u.processBooleanAttribute)(p, "loop", !1)),
      (p.responsive = (0, u.processBooleanAttribute)(p, "responsive", !1)),
      (p.ignorescroll = (0, u.processBooleanAttribute)(p, "ignorescroll", !1)),
      (p.stayiniframe = (0, u.processBooleanAttribute)(p, "stayiniframe", !1)),
      (p.securevpaid = (0, u.processBooleanAttribute)(p, "securevpaid", !1)),
      (p.noblacklist = (0, u.processBooleanAttribute)(p, "noblacklist", !1)),
      (p.hideloadingindicator = (0, u.processBooleanAttribute)(
        p,
      ...
      p.mux &&
        p.anchor &&
        (!p.muxlimit || Math.random() < parseFloat(p.muxlimit)) &&
        (0, c.enableMux)(p.anchor, p.mux, p),
      p.omnitureid)
    )
      (0, s.setup)(p.omnitureid, p);
    if (
      ((0, a.setup)(),
      (0, a.get)().addMessageListener("blacklist", function () {
      ...
      (0, a.requestAd)(Object.assign(p, w), function (t) {
        (0, c.log)("Got transport ad data: " + JSON.stringify(t)),
          (0, i.createAd)(Object.assign(p, t), function () {
            return (
              !!t.fallback &&
              ((0, i.createAd)(Object.assign(p, t.fallback)), !0)
            );
          });
      });
    }
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      (e.createAd = function t(e, n) {
        ...
        e = (function (t) {
          ...
          (t.skipdelay = parseInt(t.skipdelay ? t.skipdelay : 0)),
            t.tag && (t.href = t.tag);
          "ssid" in t &&
            ((t.href =
              "//vid.springserve.com/vast/" +
              t.ssid +
              "?w={{WIDTH}}&h={{HEIGHT}}&ua={{USER_AGENT}}&url={{ENCODED_URL}}&cb={{CACHEBUSTER}}"),
            t.debug && (t.href += "&ve=debug"));
          if (!t.href) return (0, a.log)("No tag found"), null;
          return (
            (t.preload = (0, c.processBooleanAttribute)(
              t,
              "preload",
              -1 === t.href.search("vid.springserve.com")
            )),
            (t.waitforad = (0, c.processBooleanAttribute)(t, "waitforad", !1)),
            (t.allowmute = (0, c.processBooleanAttribute)(t, "allowmute", !1)),
            t
          );
        })(e);
        ...
        try {
          (0, a.log)(
            "Loading ad with options: " + JSON.stringify(e, null, "\t")
          );
        } catch (t) {
          (0, a.log)("Loading ad, failed to stringify options");
        }
        "dummy" === e.type
          ? h(i.default, document.body)
          : "linear" === e.type
          ? (function (t, e) {
              var n = [f];
          ...
          : (0, a.log)("Unrecognized type: " + e.type, !0);
      });
    var r = f(n(343)),
      i = f(n(351)),
      o = f(n(338)),
    ...
    var p = (function () {
      function t(e, n, r) {
        ...
        (this.options_ = e),
          ...
          this.updateMuteSvg_();
        var c = 5e3;
        this.options_.timeout && (c = parseInt(this.options_.timeout)),
          -1 !== this.options_.href.indexOf("revcontent")
            ? (this.ads_ = new o.default(this, this.videoPlayer_, c))
            : -1 !== this.options_.href.indexOf("polymorph")
            ? (this.ads_ = new a.default(this, this.videoPlayer_, c))
            : -1 !== this.options_.href.indexOf("outbrain")
            ? (this.ads_ = new s.default(this, this.videoPlayer_, c))
            : (this.ads_ = new i.default(this, this.videoPlayer_, c)),
        ...
        r(t, [
          {
            ...
            value: function (t) {
              t
                ...
                : this.videoPlayer_.removeVideoEndedCallback(
                    this.videoEndedCallback_
                  );
            },
          },
          ...
          },
          {
            ...
            value: function () {
              this.adContainer_ &&
                (this.adLoading_ || this.adPlaying_
                  ? (this.adContainer_.className = "stm-ad-player")
                  : (this.adContainer_.className = "stm-ad-player hidden")),
                this.loadingContainer_ &&
                  (this.adLoading_ && !this.adPlaying_
                    ? (this.loadingContainer_.style.display = "flex")
                    : (this.loadingContainer_.style.display = "none")),
                this.adPlaying_ &&
                  (this.skipContainer_ &&
                    this.skippable_ &&
                    (this.skipContainer_.style.display = "block"),
                  this.muteContainer_ &&
                    (this.muteContainer_.style.display = "block"));
            },
          },
          {
            key: "loadAds_",
          ...
          },
          {
            key: "resumeAfterAd",
            value: function () {
              (0, l.log)("Resume after ad"),
                (this.adPlaying_ = !1),
                (this.adLoading_ = !1),
                null != this.looping &&
                  (this.videoPlayer_.contentPlayer.loop = this.looping),
                this.updateChrome_(),
                this.videoPlayer_.contentPlayer.prepHls &&
                  this.videoPlayer_.contentPlayer.prepHls(),
                this.videoPlayer_.contentPlayer.prep;
          ...
          },
          {
            key: "pauseForAd",
            value: function () {
              (0, l.log)("Pause for ad"),
                (this.looping = this.videoPlayer_.contentPlayer.loop),
                (this.videoPlayer_.contentPlayer.loop = !1),
            ...
            value: function () {
              if (!this.adsDone_)
                return (
                  ...
                  (this.adLoading_ = !0),
                  this.updateChrome_(),
                  (this.height = this.videoPlayer_.getHeight()),
                  (this.width = this.videoPlayer_.getWidth()),
                  this.emitter_.emit("request"),
                  this.ads_.initialUserAction(),
                  void this.videoPlayer_.preloadContent(
                    this.bind_(this, this.loadAds_)
                  )
                );
            },
          },
          ...
          },
          {
            ...
            value: function () {
              if (this.muteContainer_) {
                ...
                this.muted_
                  ? (this.muteContainer_.innerHTML =
                      '<svg width="100%" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="Group" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><polygon id="Shape" fill="#' +
                      t +
                      '" points="3 9 3 15 7 15 12 20 12 4 7 9"></polygon><polygon id="Shape" points="0 0 24 0 24 24 0 24"></polygon></g></svg>')
                  : (this.muteContainer_.innerHTML =
                      '<svg width="100%" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="Group" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><path d="M3,9 L3,15 L7,15 L12,20 L12,4 L7,9 L3,9 Z M16.5,12 C16.5,10.23 15.48,8.71 14,7.97 L14,16.02 C15.48,15.29 16.5,13.77 16.5,12 Z M14,3.23 L14,5.29 C16.89,6.15 19,8.83 19,12 C19,15.17 16.89,17.85 14,18.71 L14,20.77 C18.01,19.86 21,16.28 21,12 C21,7.72 18.01,4.14 14,3.23 L14,3.23 Z" id="Shape" fill="#' +
                      t +
                      '"></path><polygon id="Shape" fill="#' +
                      t +
                      '" points="3 9 3 15 7 15 12 20 12 4 7 9"></polygon><polygon id="Shape" points="0 0 24 0 24 24 0 24"></polygon></g></svg>');
              }
            },
          },
          {
            ...
            value: function () {
              var t = [
                ".stm-ad-player.hidden *, .stm-ad-player.hidden { display: none !important; }",
                ".stm-ad-player-inner > div { height: 100%; width:100%; }",
                ".stm-ad-player video { left: 0px; object-fit: cover; }",
                ".stm-ad-player-btn:hover { opacity: 1 !important; }",
                ".goog-ui-media-flash { height: 100%; width:100%; }",
                ".goog-ui-media-flash > embed { height: 100%; width:100%; }",
                "svg {-webkit-filter: drop-shadow( 0px 0px 2px rgba(0,0,0,.3)); filter: drop-shadow( 0px 0px 2px rgba(0,0,0,.3));}",
                ".stm-ad-player.animate {animation-fill-mode: forwards; transform-style: flat; transform: translate(" +
                  this.width * ("left" === this.options_.position ? 1 : -1) +
                  "px, 0px);transition: transform 1.0s ease-out;}",
              ];
              return (
                this.options_.noanimate ||
                  t.push(".stm-ad-player { transition: height .5s; }"),
                t
              );
            },
          },
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.adContainer_ = document.createElement("div")),
                (this.adContainer_.className = "stm-ad-player hidden"),
                (this.adContainer_.style.position = "relative"),
                (this.adContainer_.style.overflow = "hidden"),
                (this.adContainer_.style.margin = "0px auto"),
                (this.adContainer_.style.maxWidth = "100%"),
                (this.adContainer_.style.display = "block"),
                (this.adContainer_.style.width = "100%"),
                (this.adContainer_.style.height = "100%"),
                t.parentNode.insertBefore(this.adContainer_, t.nextSibling),
                (this.innerAdContainer_ = document.createElement("div")),
                (this.innerAdContainer_.style.backgroundColor = "transparent"),
                (this.innerAdContainer_.style.top = "0px"),
                (this.innerAdContainer_.style.left = "0px"),
                (this.innerAdContainer_.style.width = "100%"),
                (this.innerAdContainer_.style.height = "100%"),
                (this.innerAdContainer_.style.position = "absolute"),
                (this.innerAdContainer_.className = "stm-ad-player-inner"),
                this.adContainer_.appendChild(this.innerAdContainer_),
                this.options_.muteonclick &&
                  ((this.clickCatcher_ = document.createElement("div")),
                  (this.clickCatcher_.style.backgroundColor = "transparent"),
                  (this.clickCatcher_.style.top = "0px"),
                  (this.clickCatcher_.style.left = "0px"),
                  (this.clickCatcher_.style.width = "100%"),
                  (this.clickCatcher_.style.height = "100%"),
                  (this.clickCatcher_.style.position = "absolute"),
                  this.clickCatcher_.addEventListener(
                    "touchstart",
                    this.onPlayerClick_.bind(this)
                  ),
                  this.clickCatcher_.addEventListener(
                    "click",
                    this.onPlayerClick_.bind(this)
                  ),
                  this.adContainer_.appendChild(this.clickCatcher_));
              var n = null;
              if (
                (this.options_.allowmute &&
                  ...
                  (n.style.width = "6.75%"),
                  (n.style.height = "12%"),
                  (n.style.maxWidth = "25px"),
                  (n.style.maxHeight = "25px"),
                  (n.style.opacity = 0.75),
                  (n.style.display = "none"),
                  (n.style.padding = "6px"),
                  (n.style.cursor = "pointer"),
                  (n.style.zIndex = "2147483647"),
                  this.adContainer_.appendChild(this.muteContainer_),
                  this.muteContainer_.addEventListener(
                    "touchstart",
                    this.onMuteClick_.bind(this)
                  ),
                  this.muteContainer_.addEventListener(
                    "click",
                    this.onMuteClick_.bind(this)
                  )),
                (this.muteContainer_ = n),
                -1 !== this.options_.skipdelay)
              ) {
                var r = document.createElement("div");
                (r.className = "stm-ad-player-btn"),
                  ...
                  (r.style.width = "6.75%"),
                  (r.style.height = "12%"),
                  (r.style.maxWidth = "25px"),
                  (r.style.maxHeight = "25px"),
                  (r.style.opacity = 0.75),
                  (r.style.padding = "6px"),
                  (r.style.cursor = "pointer"),
                  (r.style.zIndex = "2147483647"),
                  (r.innerHTML =
                    '<svg width="100%" viewBox="0 0 58 58" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="Group" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><polygon id="Shape" fill="#' +
                    e +
                    '" points="45.9166667 15.4908333 42.5091667 12.0833333 29 25.5925 15.4908333 12.0833333 12.0833333 15.4908333 25.5925 29 12.0833333 42.5091667 15.4908333 45.9166667 29 32.4075 42.5091667 45.9166667 45.9166667 42.5091667 32.4075 29"></polygon><polygon id="Shape" points="0 0 58 0 58 58 0 58"></polygon></g></svg>'),
                  (this.skipContainer_ = r),
                  this.skipContainer_.addEventListener(
                    "touchstart",
                    this.onSkipClick_.bind(this)
                  ),
                  this.skipContainer_.addEventListener(
                    "click",
                    this.onSkipClick_.bind(this)
                  ),
                  this.adContainer_.appendChild(r);
              }
              if (
                "transparent" !== this.options_.background &&
                !this.options_.hideloadingindicator
              ) {
                ...
                (i.style.position = "absolute"),
                  ...
                  (this.loadingContainer_ = i),
                  this.adContainer_.appendChild(this.loadingContainer_),
                  (i.innerHTML =
                    '<svg version="1.1" id="loader-1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40px" viewBox="0 0 50 50" style="enable-background:new 0 0 50 50;" xml:space="preserve"><path fill="#' +
                    e +
                    '" d="M43.935,25.145c0-10.318-8.364-18.683-18.683-18.683c-10.318,0-18.683,8.365-18.683,18.683h4.068c0-8.071,6.543-14.615,14.615-14.615c8.072,0,14.615,6.543,14.615,14.615H43.935z"><animateTransform attributeType="xml" attributeName="transform" type="rotate" from="0 25 25" to="360 25 25" dur="0.6s" repeatCount="indefinite"/></path></svg>');
              }
              this.videoPlayer_ = new u.default(
                this.adContainer_,
                this.anchor_,
                this.innerAdContainer_
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              t.stopPropagation(),
                t.preventDefault(),
                (0, l.log)("Mute click"),
                this.setMute(!this.muted_),
                (this.userOverrideMute_ = !0);
            },
          },
          {
            key: "onContentEnded_",
        ...
        function () {
          "undefined" != typeof google
            ? (google.ima.settings.setVpaidMode(
              ...
              (i.adDisplayContainer_ = new google.ima.AdDisplayContainer(
                i.videoPlayer_.adContainer,
                i.videoPlayer_.contentPlayer,
                i.customClickDiv_
              )),
              (i.adsLoader_ = new google.ima.AdsLoader(i.adDisplayContainer_)),
              (i.adsManager_ = null),
              i.adsLoader_.addEventListener(
                google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,
                i.onAdsManagerLoaded_,
                i,
                r
              ),
              i.adsLoader_.addEventListener(
            ...
            : (0, a.log)("IMA library failed to load.");
        }
      );
    };
    (s.prototype.initialUserAction = function () {
      if (!this.adDisplayContainer_)
        return this.onAdError_(), void (0, a.log)("No ad display container");
      this.adDisplayContainer_.initialize(),
        this.videoPlayer_.contentPlayer.load(),
        (0, a.log)("Loading video after initial user action");
    }),
      (s.prototype.requestAds = function (t) {
        if ("undefined" == typeof google)
          return (
            this.onAdError_(),
            void (0, a.log)("IMA SDK failed to load to request ads")
          );
        var e = new google.ima.AdsRequest();
        (e.adTagUrl = t),
          (e.linearAdSlotWidth = this.videoPlayer_.getWidth()),
          (e.linearAdSlotHeight = this.videoPlayer_.getHeight()),
          (e.nonLinearAdSlotWidth = this.videoPlayer_.getWidth()),
          (e.nonLinearAdSlotHeight = this.videoPlayer_.getHeight()),
          this.adsLoader_.requestAds(e);
      }),
      ...
      (s.prototype.resize = function (t, e) {
        this.adsManager_ &&
          this.adsManager_.resize(t, e, google.ima.ViewMode.FULLSCREEN);
      }),
      (s.prototype.contentEnded = function () {
        (this.contentCompleteCalled_ = !0),
          this.adsLoader_ && this.adsLoader_.contentComplete();
      }),
      (s.prototype.onAdsManagerLoaded_ = function (t) {
        ...
        (e.restoreCustomPlaybackStateOnAdBreakComplete = !0),
          ...
          (e.loadVideoTimeout = this.timeout),
      ...
      (s.prototype.startAdsManager_ = function (t) {
        ...
        (0, a.log)("Init manager (" + r + "x" + i + ")"),
          t.init(r, i, google.ima.ViewMode.NORMAL),
          t.start();
      }),
      (s.prototype.onContentPauseRequested_ = function () {
        this.application_.pauseForAd(),
          this.application_.setVideoEndedCallbackEnabled(!1);
      }),
      (s.prototype.onContentResumeRequested_ = function () {
        this.application_.setVideoEndedCallbackEnabled(!0),
      ...
      (s.prototype.onAdEvent_ = function (t) {
        if (t) {
          ...
          t.type == google.ima.AdEvent.Type.CLICK
            ...
            ? (e.isLinear() || this.onContentResumeRequested_(),
              this.application_.adLoaded(e))
            : t.type == google.ima.AdEvent.Type.VOLUME_MUTED
            ? this.application_.adVolumeChanged(e, 0)
            : t.type == google.ima.AdEvent.Type.VOLUME_CHANGED
            ? this.application_.adVolumeChanged(e, this.adsManager_.getVolume())
            : t.type == google.ima.AdEvent.Type.STARTED
            ? this.application_.adStarted(e)
            : t.type == google.ima.AdEvent.Type.ALL_ADS_COMPLETED
            ? this.application_.adComplete()
            : t.type == google.ima.AdEvent.Type.SKIPPED &&
              this.application_.adSkipped();
        } else (0, a.log)("No ad event provided.");
      }),
      (s.prototype.onAdError_ = function (t) {
        var e = "";
        t && (e = t.getError().toString()),
          (0, a.log)("Ad error: " + e),
          this.adsManager_ && this.adsManager_.destroy(),
          this.application_.resumeAfterAd(),
          this.application_.adError(e);
      }),
      (e.default = s),
      (t.exports = e.default);
  },
  function (t, e, n) {
    ...
    (a.prototype.initialUserAction = function () {}),
      (a.prototype.requestAds = function (t) {
        var e = this;
        fetch(t)
          .then(function (t) {
            return t.json();
          ...
          .then(function (t) {
            ...
            for (var r = 0; r < 6 && r < t.length; r++) {
              var i = t[r];
              n +=
                "<a onclick='javascript: event.stopPropagation(); return true;' class='revcontent-ad' target='_blank' href='" +
                i.url +
                "'><img class='revcontent-image' src='" +
                i.image +
                "'></img><div class='revcontent-headline'>" +
                i.headline +
                "</div></a>";
            }
            n += "</div></div>";
            ...
            (o.style.width = "100%"),
              (o.style.height = "100%"),
              (o.style.border = "none"),
              (o.style.background = "rgba(255,255,255,.9)"),
              e.adContainer_.appendChild(o);
            ...
            (c.style.position = "absolute"),
              ...
              (c.style.right = "0px"),
              (c.style.width = "100%"),
              (c.style.backgroundColor = "#0f90fa"),
              (c.style.opacity = 0.3),
              e.adContainer_.appendChild(s),
              e.adContainer_.appendChild(c);
            var u = 15;
            (s.onclick = function () {
              ...
              (e.countdownInterval = setInterval(function () {
                (u -= 0.2),
                  (c.style.width = ((100 / 15) * u).toFixed(1) + "%"),
                  Math.floor(u) <= 10
                    ? ((s.innerHTML = "Skip Ad"),
                      (s.style.opacity = 1),
                      (s.disabled = !1))
                    : ((s.innerHTML =
                        "Skip in " + Math.floor(u - 10).toString() + "s"),
                      (s.style.opacity = 0.3),
                      (s.disabled = !0)),
                  u <= 0 &&
                    (clearInterval(e.countdownInterval),
                    e.application_.resumeAfterAd(),
                    e.application_.adComplete());
              }, 200)),
              e.application_.adStarted();
          })
          .catch(function (t) {
            e.onAdError_(t);
          });
      }),
      (a.prototype.contentEnded = function () {}),
      (a.prototype.onAdError_ = function (t) {
        var e = "";
        t && (e = t.toString()),
          (0, o.log)("Ad error: " + e),
          this.application_.resumeAfterAd(),
  ...
  function (t, e, n) {
    ...
    var c = function (t, e, n) {
      ...
      var r = r || {};
      (r.cmdQ = r.cmdQ || []),
        r.cmdQ.push(function () {
          r.updateConfig({ currentPageUrl: (0, a.getPageURL)() });
        });
    };
    (c.prototype.initialUserAction = function () {}),
      (c.prototype.requestAds = function (t) {
        var e = this;
        (0, s.log)("Requesting polymorph"),
          (0, o.default)(
            "//static.adsnative.com/static/js/render.v2.js",
            function () {
              adsnativetag.cmdQ.push(function () {
                ...
                (n.style.position = "absolute"),
                  ...
                  (n.style.right = "0px"),
                  (n.style.width = "100%"),
                  (n.style.backgroundColor = "#0f90fa"),
                  (n.style.opacity = 0.3);
                var r = document.createElement("div");
                (r.id = "polymorph-container"),
                  (r.style.paddingTop = "50px"),
                  (r.style.background = "rgba(255,255,255,.9)");
                var i = document.createElement("div");
                (i.id = "polymorph-content"),
                  r.appendChild(i),
                  e.adContainer_.appendChild(t),
                  e.adContainer_.appendChild(n),
                  e.adContainer_.appendChild(r);
                var o = 15;
                (t.onclick = function () {
                  e.application_.resumeAfterAd(), e.application_.adSkipped();
                }),
                  (e.countdownInterval = setInterval(function () {
                    (o -= 0.2),
                      (n.style.width = ((100 / 15) * o).toFixed(1) + "%"),
                      Math.floor(o) <= 10
                        ? ((t.innerHTML = "Skip Ad"),
                          (t.style.opacity = 1),
                          (t.disabled = !1))
                        : ((t.innerHTML =
                            "Skip in " + Math.floor(o - 10).toString() + "s"),
                          (t.style.opacity = 0.3),
                          (t.disabled = !0)),
                      o <= 0 &&
                        (clearInterval(e.countdownInterval),
                ...
                var c = adsnativetag.defineAdUnit({
                    ...
                    callbackOnAdResponse: function (t, n) {
                      (0, s.log)("polymorph callback status: " + t),
                        t ||
                          (clearInterval(e.countdownInterval),
                          e.application_.resumeAfterAd(),
                          e.application_.adError("No ad returned"));
                    },
                  }),
                  u = adsnativetag.displayAdUnit(
                    c,
                    "polymorph-content",
                    function (t) {
                      (0, s.log)("polymorph rendered"),
                        e.application_.adStarted();
                    }
                  );
                (0, s.log)("polymorph display status: " + u),
                  (0, s.log)("polymorph current url: " + (0, a.getPageURL)()),
                  adsnativetag.requestAds(function (t, n) {
                    (0, s.log)("polymorph request ad status: " + t),
                      t ||
                        (clearInterval(e.countdownInterval),
                        e.application_.resumeAfterAd(),
                        e.application_.adError("No ad returned"));
      ...
      (c.prototype.contentEnded = function () {}),
      (e.default = c),
      (t.exports = e.default);
  },
  function (t, e, n) {
    ...
    var r,
      ...
      s = n(43);
    var c = function (t, e, n) {
      (this.adContainer_ = e.adContainer),
        (this.application_ = t),
        (this.request_data = {
          permalink:
            (0, a.createOutbrainSource)(
              (0, a.extractDomain)((0, a.getPageURL)())
            ) +
            "?oburltocrawl=" +
            (0, a.getPageURL)(),
          widgetId: "JS_1",
    ...
    (c.prototype.initialUserAction = function () {}),
      (c.prototype.requestAds = function (t) {
        var e = this;
        (0, s.log)("Requesting outbrain"),
          (0, o.default)("//widgets.outbrain.com/outbrain.js", function () {
            var t = document.createElement("button");
            (t.style.position = "absolute"),
              (t.style.right = "25px"),
              (t.style.top = "285px"),
              (t.style.width = "100px"),
              (t.style.fontSize = "14px"),
              (t.style.border = "3px solid #e0e0e0"),
              (t.style.borderRadius = "5px"),
              (t.style.padding = "8px"),
              (t.style.color = "#383838"),
              (t.style.cursor = "pointer"),
              (t.innerHTML = "Skip in 5s"),
              (t.style.zIndex = "200"),
              (t.style.opacity = 0.3);
            ...
            (i.id = "polymorph-content"),
              ...
              (i.style.fontFamily = "OpenSans,Helvetica,sans-serif"),
              r.appendChild(i),
              e.adContainer_.appendChild(t),
              e.adContainer_.appendChild(n),
              e.adContainer_.appendChild(r);
            ...
            var a = function (t) {
              ...
              (r.style.color = "#FAFAFA"),
                ...
                (r.style.padding = "8px 10px 0px 10px"),
                (r.style.background = "rgba(0,0,0,.7)"),
                (r.style.position = "absolute"),
                (r.style.left = 0),
                (r.style.right = 0),
                (r.style.bottom = "23px"),
                (r.style.textAlign = "left"),
                (r.style.lineHeight = "18px"),
                (r.innerHTML = t.content);
              var i = document.createElement("div");
              return (
                (i.style.color = "#FAFAFA"),
                (i.style.fontSize = "12px"),
                (i.style.padding = "4px 10px 8px 10px"),
                (i.style.background = "rgba(0,0,0,.7)"),
                (i.style.position = "absolute"),
                ...
                (i.style.lineHeight = "11px"),
                (i.style.color = "#AAA"),
                (i.innerHTML = t.source_name),
                e.appendChild(n),
                e.appendChild(r),
                e.appendChild(i),
                (e.onclick = function () {
            ...
            (0, s.log)("sending OBR request"),
              OBR.extern.callRecs(e.request_data, function (t) {
                if (!t.doc.length)
                  return (
                    clearTimeout(e.countdownInterval),
                    (0, s.log)("No outbrain ads found"),
                    e.application_.resumeAfterAd(),
                    void e.application_.adError("No ad returned")
                  );
                for (var n, r = 0; r < t.doc.length; r++) {
                  var o = t.doc[r];
                  (0, s.log)(JSON.stringify(o)),
                    (0, s.log)(
                      "Recommendation title:" + o.content + " and url: " + o.url
                    ),
                    r < 2 && ((n = a(o)), i.appendChild(n));
                }
                var c = document.createElement("div");
                (c.style.color = "#8e8e8e"),
                  ...
                  (c.innerHTML =
                    "<a href='https://www.outbrain.com/what-is/' target='_blank' style='text-decoration: none; color: #8e8e8e'>Recommended by <img src='https://v.embed-cdn.com/assets/outbrain-logo-gray.png' height='10' width='53'></a>"),
                  i.appendChild(c),
                  e.application_.adStarted();
              });
          });
      ...
      (e.parse = function (t, e) {
        ...
        return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t =
          (t = (t = (t = (t = (t = t.replace(/&amp;/g, "&")).replace(
            /{{ENCODED_URL}}/g,
            i
          )).replace(/{{CONTENT_LENGTH}}/g, 500)).replace(
            /{{CACHEBUSTER}}/g,
            Math.random().toString(36).substr(2, 16)
          )).replace(/{{WIDTH}}/g, e.width)).replace(
            /{{HEIGHT}}/g,
            e.height
          )).replace(
          /{{USER_AGENT}}/g,
          encodeURIComponent(navigator.userAgent)
        )).replace(/\[PAGE_URL\]/g, i)).replace(/\[PAGEURL\]/g, i)).replace(
          /\[CONTENT_ID\]/g,
          e.shortcode || "UNKNOWN"
        )).replace(
          /\[CONTENT_TITLE\]/g,
          encodeURIComponent(e.title) || "UNKNOWN"
        )).replace(/\[CONTENT_URL\]/g, encodeURIComponent(n))).replace(
          /\[CONTENT_LENGTH\]/g,
          500
        )).replace(
          /\[CACHEBUSTER\]/g,
          ...
          /\[DO_NOT_TRACK\]/g,
          encodeURIComponent(navigator.doNotTrack || 0)
        ));
      });
    var r = n(48);
  },
            ...
            for (
              ...
              try {
                ...
                if (
                  ((h = n.read
                    ? n.read(h, v)
                    : n(h, v) || h.replace(f, decodeURIComponent)),
                  this.json)
                )
                  try {
                    h = JSON.parse(h);
  ...
  function (module, exports, __webpack_require__) {
    ...
    function Visitor(q, w) {
      ...
      (a.Rb = n),
        ...
        (a.u = function (t, e) {
          var n,
            ...
            f = 10;
          if (
            (e === o && (y.isClientSideMarketingCloudVisitorID = i), 1 == t)
          ) {
            for (a += "ABCDEF", n = 0; 16 > n; n++)
        ...
        (a.cookieRead = function (t) {
          ...
          return 0 > n
            ? ""
            : decodeURIComponent(
                e.substring(n + 2 + t.length, 0 > r ? e.length : r)
              );
        }),
        (a.cookieWrite = function (t, e, n) {
          e = "" + e;
          var r,
            i = (i = a.cookieLifetime) ? ("" + i).toUpperCase() : "";
          return (
            n && "SESSION" != i && "NONE" != i
              ? (r = "" != e ? parseInt(i || 0, 10) : -60)
                ? (n = new Date()).setTime(n.getTime() + 1e3 * r)
                : 1 == n &&
                  ((r = (n = new Date()).getYear()),
                  n.setYear(r + 2 + (1900 > r ? 1900 : 0)))
              : (n = 0),
            t && "NONE" != i
              ? ((v.cookie =
        ...
        (a.t = function (t, e) {
          if (a.h != j) {
            var n = a.h[t];
            if (n) for (; 0 < n.length; ) a.z(n.shift(), e);
          }
        }),
        ...
        (a.ha = function () {
          ...
          t &&
            ...
            (a._supplementalDataIDCurrentConsumed.SDID_URL_PARAM = i));
        }),
        (a.ga = function () {
          var e = a.eb();
          if (
            e &&
            e.TS &&
            !(Math.floor((m.Da() - e.TS) / 60) > n.Qa || e[G] !== q)
          ) {
            var i = e[o],
                  ...
                  (function (t) {
                    (t = t || {}),
                      (a._supplementalDataIDCurrent =
                        t.supplementalDataIDCurrent || ""),
                      (a._supplementalDataIDCurrentConsumed =
                        t.supplementalDataIDCurrentConsumed || {}),
                      (a._supplementalDataIDLast =
                        t.supplementalDataIDLast || ""),
                      (a._supplementalDataIDLastConsumed =
                        t.supplementalDataIDLastConsumed || {});
                  })(e.sdid);
              }
            } catch (t) {
        ...
        (a.l = j),
        (a.$a = function (t, e, n, r) {
          (e = a.s(e, "d_fieldgroup", t, 1)),
            (r.url = a.s(r.url, "d_fieldgroup", t, 1)),
            (r.m = a.s(r.m, "d_fieldgroup", t, 1)),
            (y.d[t] = i),
            r === Object(r) && r.m && "XMLHttpRequest" === a.pa.F.G
              ? a.pa.rb(r, n, t)
              : a.useCORSOnly || a.ab(t, e, n);
        }),
        (a.ab = function (t, e, n) {
          var r,
            o = 0,
          ...
          if (e && v) {
            for (r = 0; !o && 2 > r; ) {
              try {
                o =
                  (o = v.getElementsByTagName(0 < r ? "HEAD" : "head")) &&
                  0 < o.length
                    ? o[0]
                    : 0;
              } catch (t) {
        ...
        (a.isAllowed = function () {
          return (
            !a.la &&
              ((a.la = i),
              a.cookieRead(a.cookieName) ||
                a.cookieWrite(a.cookieName, "T", 1)) &&
              (a.ma = i),
            a.ma
          );
        }),
      ...
      u || (u = "NONE"),
        ...
        (a.ja = function () {
          if (!a.N) {
            var t = a.version;
            a.audienceManagerServer && (t += "|" + a.audienceManagerServer),
            ...
            if ((a.b == j && (a.b = {}), l && "T" != l))
              for (
                ...
                (e = (t = l[c].split("-"))[0]),
                  (o = l[c + 1]),
                  1 < t.length
                    ? ((s = parseInt(t[1], 10)), (t = 0 < t[1].indexOf("s")))
                    : ((s = 0), (t = k)),
                  u &&
                    (e == I && (o = ""), 0 < s && (s = f.getTime() / 1e3 - 60)),
                  e &&
                    o &&
                    (a.e(e, o, 1),
                    0 < s &&
                      ((a.b["expire" + e] = s + (t ? "s" : "")),
                      f.getTime() >= 1e3 * s ||
                        (t && !a.cookieRead(a.sessionCookieName)))) &&
                    (a.c || (a.c = {}), (a.c[e] = i));
            !a.a(r) &&
              m.o() &&
              (l = a.cookieRead("s_vi")) &&
              1 < (l = l.split("|")).length &&
              0 <= l[0].indexOf("v1") &&
              (0 <= (c = (o = l[1]).indexOf("[")) && (o = o.substring(0, c)),
              o && o.match(n.w) && a.e(r, o));
          }
        }),
        (a._appendVersionTo = function (t) {
          ...
          return (
            r
              ? m.jb(r, a.version) && (t = t.replace(n.fa, e))
              : (t += (t ? "|" : "") + e),
            t
          );
        }),
        ...
        (a.Yb = function (t, e, n) {
          ...
          if (e)
            for (r in ((i = []), e))
              Object.prototype[r] || (i.push(r), i.push(e[r]));
          a.gb(t, i, n);
        }),
        (a.j = function (t, e, n) {
          var r = new Date();
          r.setTime(r.getTime() + 1e3 * e),
            ...
            0 > e ? (a.c || (a.c = {}), (a.c[t] = i)) : a.c && (a.c[t] = k),
            n &&
            ...
            t &&
              ("object" == (void 0 === t ? "undefined" : _typeof(t)) &&
                (t = t.d_mid
                  ...
                  ? t.uuid
                  : "" + t),
              t && "NOTARGET" == (t = t.toUpperCase()) && (t = u),
              !t || (t != u && !t.match(n.w))) &&
              (t = ""),
            t
          );
        ...
        (a.k = function (e, n) {
          if (
            (a.Wa(e),
            a.i != j && (a.i[e] = k),
            p.d[e] && ((p.d[e].Nb = p.p()), p.J(e)),
            y.d[e] && y.Na(e, k),
            e == H)
          ) {
            y.isClientSideMarketingCloudVisitorID !== i &&
              (y.isClientSideMarketingCloudVisitorID = k);
            var s = a.a(o);
            if (!s || a.overwriteCrossDomainMCIDAndAID) {
              if (
                !(s =
                  "object" == (void 0 === n ? "undefined" : _typeof(n)) && n.mid
                    ? n.mid
                    : a.ia(n))
              ) {
          ...
          if (e == D && "object" == (void 0 === n ? "undefined" : _typeof(n))) {
            (s = 604800),
              n.id_sync_ttl != F &&
                n.id_sync_ttl &&
                (s = parseInt(n.id_sync_ttl, 10));
            var c = a.a(A);
            c ||
              ((c = n.d_region) || (c = n.dcs_region),
              c && (a.j(A, s), a.e(A, c))),
              c || (c = ""),
              a.t(A, [c]),
              (c = a.a(t)),
              (n.d_blob || n.blob) &&
                ((c = n.d_blob) || (c = n.blob), a.j(t, s), a.e(t, c)),
              c || (c = ""),
              a.t(t, [c]),
              !n.error_msg && a.C && a.e(I, a.C);
          }
          var l;
          (e == E &&
            (((s = a.a(r)) && !a.overwriteCrossDomainMCIDAndAID) ||
              ((s = a.ia(n)) ? s !== u && a.j(t, -1) : (s = u), a.e(r, s)),
            (s && s != u) || (s = ""),
            a.t(r, [s])),
          ...
          n === Object(n)) &&
            ...
            l ||
              ((l = u),
              n.d_optout &&
                n.d_optout instanceof Array &&
                (l = n.d_optout.join(",")),
              (s = parseInt(n.d_ottl, 10)),
              isNaN(s) && (s = 7200),
              a.j(C, s, i),
              a.e(C, l)),
            a.t(C, [l]));
        ...
        (a.v = function (e, n, s, c, l) {
          ...
          if (a.isAllowed())
            if (
              (a.f(),
              !(!(d = a.a(e, N[e] === i)) || (a.c && a.c[e])) ||
                (a.disableThirdPartyCalls && !h))
            )
              d ||
                (e === o
                  ? (a.M(e, s),
                    (d = a.u(0, o)),
                    a.setMarketingCloudVisitorID(d))
                  : e === r
                  ? (a.M(e, s), (d = ""), a.setAnalyticsVisitorID(d))
                  : ((d = ""), (c = i)));
            else if (
              (e == o || e == C
                ? (f = H)
                ...
                !n ||
                  ...
                  a.$a(
                    ...
                    function (t) {
                      a.a(e) ||
                        (p.d[f] &&
                          ((p.d[f].timeout = p.p()), (p.d[f].xb = !!t), p.J(f)),
                        t && y.Na(f, i),
                        (t = ""),
                        e == o
                          ? (t = a.u(0, o))
                          : f == D && (t = { error_msg: "timeout" }),
                        a.k(f, t));
                    },
                    l
                  )),
        ...
        (a.D = k),
        (a.getMarketingCloudVisitorID = function (t, e) {
          if (a.isAllowed()) {
            ...
            for (e in (a.f(), t))
              if (!Object.prototype[e] && (n = t[e]))
                if ("object" == (void 0 === n ? "undefined" : _typeof(n))) {
                  var r = {};
                  n.id && (r.id = n.id),
                    n.authState != F && (r.authState = n.authState),
                    (a.A[e] = r);
                } else a.A[e] = { id: n };
        ...
        (a.getCustomerIDs = function () {
          ...
          for (t in a.A)
            Object.prototype[t] ||
              ...
              e.id && (n[t].id = e.id),
              (n[t].authState =
                e.authState != F ? e.authState : l.AuthState.UNKNOWN));
          return n;
        }),
        ...
        (a.getAnalyticsVisitorID = function (t, e, n) {
          ...
          if (a.isAllowed()) {
            ...
            if (
              (n ||
                (s = a.getMarketingCloudVisitorID(function () {
              ...
              a.loadSSL &&
                (n
                  ? a.marketingCloudServerSecure &&
                    (c = a.marketingCloudServerSecure)
                  : a.trackingServerSecure && (c = a.trackingServerSecure));
              var l = {};
              if (c) {
        ...
        (a.B = function (e) {
          var n = a.audienceManagerServer,
            ...
            f =
              (f = a.a(r)) && f != u
                ? "&d_cid_ic=AVID%01" + encodeURIComponent(f)
                : "";
          if (
            (a.loadSSL &&
              a.audienceManagerServerSecure &&
              (n = a.audienceManagerServerSecure),
            n)
          ) {
            var p, d;
              ...
              for (p in s)
                Object.prototype[p] ||
                  ...
                  (f +=
                    ...
                    (d.authState ? "%01" + d.authState : "")));
            return (
              e || (e = "_setAudienceManagerFields"),
              (n = "http" + (a.loadSSL ? "s" : "") + "://" + n + "/id"),
              (c =
                "d_visid_ver=" +
                a.version +
                "&d_rtbd=json&d_ver=2" +
                ...
                (c ? "&d_mid=" + encodeURIComponent(c) : "") +
                (a.idSyncDisable3rdPartySyncing ? "&d_coppa=true" : "") +
                (l ? "&d_blob=" + encodeURIComponent(l) : "") +
                f),
              (l = ["s_c_il", a._in, e]),
              {
        ...
        (a.getAudienceManagerLocationHint = function (t, e) {
          if (
            ...
            if (
              (!n &&
                m.o() &&
                (n = a.getAnalyticsVisitorID(function () {
                  a.getAudienceManagerLocationHint(t, i);
                })),
              n || !m.o())
            )
              return (n = a.B()), a.v(A, n.url, t, e, n);
          }
          return "";
        }),
        (a.getLocationHint = a.getAudienceManagerLocationHint),
        (a.getAudienceManagerBlob = function (e, n) {
          if (
            a.isAllowed() &&
            a.getMarketingCloudVisitorID(function () {
            ...
            (!(o = a.a(r)) &&
              m.o() &&
              (o = a.getAnalyticsVisitorID(function () {
                a.getAudienceManagerBlob(e, i);
              })),
            o || !m.o())
          ) {
        ...
        (a._supplementalDataIDLast = ""),
        (a._supplementalDataIDLastConsumed = {}),
        (a.getSupplementalDataID = function (t, e) {
          !a._supplementalDataIDCurrent &&
            !e &&
            (a._supplementalDataIDCurrent = a.u(1));
          var n = a._supplementalDataIDCurrent;
          return (
            a._supplementalDataIDLast && !a._supplementalDataIDLastConsumed[t]
              ? ((n = a._supplementalDataIDLast),
                (a._supplementalDataIDLastConsumed[t] = i))
              : n &&
                (a._supplementalDataIDCurrentConsumed[t] &&
                  ((a._supplementalDataIDLast = a._supplementalDataIDCurrent),
                  (a._supplementalDataIDLastConsumed =
                    a._supplementalDataIDCurrentConsumed),
                  (a._supplementalDataIDCurrent = n = e ? "" : a.u(1)),
                  (a._supplementalDataIDCurrentConsumed = {})),
                n && (a._supplementalDataIDCurrentConsumed[t] = i)),
            n
          );
        }),
        ...
        (a.isOptedOut = function (t, e, n) {
          return a.isAllowed()
            ? (e || (e = l.OptOut.GLOBAL),
              (n = a.getOptOut(function (n) {
                a.z(t, [n == l.OptOut.GLOBAL || 0 <= n.indexOf(e)]);
              }, n))
                ? n == l.OptOut.GLOBAL || 0 <= n.indexOf(e)
                : j)
            : k;
        }),
        ...
        (a.ra = {
          postMessage: function (t, e, r) {
            ...
            e &&
              (n.r
                ? r.postMessage(t, e.replace(/([^:]+:\/\/[^\/]+).*/, "$1"))
                : e &&
                  (r.location =
                    e.replace(/#.*$/, "") + "#" + +new Date() + i++ + "&" + t));
          },
          X: function (t, e) {
            var r;
            try {
              n.r &&
                ...
                window.addEventListener
                  ? window[t ? "addEventListener" : "removeEventListener"](
                      "message",
                      r,
                      !1
                    )
                  : window[t ? "attachEvent" : "detachEvent"]("onmessage", r));
            } catch (t) {}
          },
        });
      var m = {
        O: v.addEventListener
          ? function (t, e, n) {
              t.addEventListener(
                e,
                function (t) {
        ...
        yb: function (t, e, n) {
          return t !== r
            ? k
            : (e || (e = a.trackingServer),
              n || (n = a.trackingServerSecure),
              "string" == typeof (t = a.loadSSL ? n : e) && t.length
                ? 0 > t.indexOf("2o7.net") && 0 > t.indexOf("omtrdc.net")
                : k);
        },
        Ga: function (t) {
            ...
            if (i && "object" === (void 0 === i ? "undefined" : _typeof(i)))
              for (n in i)
                Object.prototype.hasOwnProperty.call(i, n) &&
                  (void 0 !== (r = c(i, n)) ? (i[n] = r) : delete i[n]);
            return b.call(t, e, i);
          }
          if (
            "object" ===
      ...
      (a.Xb = m),
        (a.pa = {
          ...
          rb: function (t, e, n) {
            ...
            try {
              var o = this.tb();
              o.open("get", t.m + "&ts=" + new Date().getTime(), i),
                "XMLHttpRequest" === this.F.G &&
                  ((o.withCredentials = i),
                  (o.timeout = a.loadTimeout),
                  o.setRequestHeader(
                    "Content-Type",
                  ...
                  (o.onreadystatechange = function () {
                    if (4 === this.readyState && 200 === this.status)
                      t: {
                        ...
                        try {
                          if (
                            (e = JSON.parse(this.responseText)) !== Object(e)
                          ) {
          ...
          n: function (t, e, n) {
            a.CORSErrors.push({ ac: t, error: e, description: n }),
      ...
      var z = {
        ...
        ub: function () {
          ...
          return (
            ...
            a.loadSSL &&
              (t = a.idSyncSSLUseAkamai ? "https://fast." : "https://"),
        ...
        Q: function () {
          function t() {
            ((r = document.createElement("iframe")).sandbox =
          ...
          r
            ? "IFRAME" !== r.nodeName
              ...
              ? e()
              : ((this.H = i), (this.Fa = r), this.q())
            : t(),
            (this.Fa = r);
        },
        q: function (t) {
          var e = this;
          t === Object(t) && (this.T.push(t), this.Jb(t)),
            (this.Ka || !n.r || this.H) &&
              this.T.length &&
              (this.J(this.T.shift()), this.q()),
            !a.idSyncDisableSyncs &&
              this.H &&
              this.I.length &&
              !this.Y &&
        ...
        Jb: function (t) {
          ...
          if ((e = t.ibs) && e instanceof Array && (n = e.length))
            for (t = 0; t < n; t++)
              (r = e[t]).syncOnPage && this.ua(r, "", "syncOnPage");
        },
        J: function (t) {
          var e,
            n,
            ...
            for (r = 0; r < n; r++)
              (i = e[r]),
                ...
                i.syncOnPage ||
                  (this.ta
                    ? this.P(o.join("|"))
                    : i.fireURLSync && this.ua(i, o.join("|")));
          this.Ab.push(t);
        },
        ua: function (t, e, r) {
          ...
          s
            ? ((s = s.split("*")),
              (c = (u = this.Kb(s, t.id, l)).pb),
              (u = u.qb),
              (!c || !u) && this.Aa(r, t, e, s, o, l))
            : ((s = []), this.Aa(r, t, e, s, o, l));
        },
        Kb: function (t, e, n) {
          var r,
            o,
        ...
        Bb: function (t) {
          if (t.join("*").length > this.da)
            for (
              t.sort(function (t, e) {
                return (
                  parseInt(t.split("-")[1], 10) - parseInt(e.split("-")[1], 10)
                );
              });
              t.join("*").length > this.da;
                  ...
                  (function (t, e, n, r) {
                    return function () {
                      ...
                      var o,
                        ...
                        f = [];
                      if ((o = a.a(i)))
                        for (c = 0, u = (o = o.split("*")).length; c < u; c++)
                          (l = o[c]).match("^" + e.id + "-") || f.push(l);
                      s.Oa(f, e, n, r);
                    };
                  })(this.W.length, e, i, o)
                ),
        ...
        P: function (t) {
          ...
          this.I.push(
            (a.Ub ? e("---destpub-debug---") : e("---destpub---")) + t
          );
        },
        Oa: function (t, e, n, r) {
          t.push(e.id + "-" + (r + Math.ceil(e.ttl / 60 / 24))),
            this.Bb(t),
            a.e(n, t.join("*"));
        },
        Ma: function () {
          ...
          this.I.length
            ? ((t = this.I.shift()),
              a.ra.postMessage(t, this.url, this.Fa.contentWindow),
              this.Cb.push(t),
              setTimeout(function () {
                e.Ma();
              }, this.Ha))
        ...
        X: function (t) {
          ...
          "string" == typeof t &&
            ...
            ("canSetThirdPartyCookies" ===
              (e = t.replace(e, "").split("|"))[0] &&
              ((this.ta = "true" === e[1] ? i : k), (this.Ka = i), this.q()),
            this.Db.push(t));
        },
        Ib: function (t) {
          (this.url === j ||
            (t.subdomain && "nosubdomainreturned" === this.g)) &&
            ((this.g =
              "string" == typeof a.qa && a.qa.length
                ? a.qa
                : t.subdomain || ""),
            (this.url = this.ub())),
            t.ibs instanceof Array && t.ibs.length && (this.ya = i),
            this.Ja() &&
            ...
            "function" == typeof a.idSyncIDCallResult
              ? a.idSyncIDCallResult(t)
              : this.q(t),
            "function" == typeof a.idSyncAfterIDCallResult &&
              a.idSyncAfterIDCallResult(t);
        },
        lb: function (t, e) {
      ...
      var p = {
        ...
        J: function (t) {
          var e = this.d[t],
            n = {};
          (n.d_visid_stg_timeout_captured = e.xa),
            (n.d_visid_cors = e.wa),
            (n.d_fieldgroup = t),
            (n.d_settimeout_overriden = e.va),
            e.timeout
              ? e.xb
                ? ((n.d_visid_timedout = 1),
                  (n.d_visid_timeout = e.timeout - e.requestStart),
              ...
              : ((n.d_visid_timedout = 0),
                (n.d_visid_timeout = -1),
                (n.d_visid_response = e.Nb - e.requestStart)),
            (n.d_visid_url = e.url),
            l.aa ? this.send(n) : this.V.push(n),
            delete this.d[t];
        },
        Lb: function () {
      ...
      var y = {
        ...
        Na: function (t, e) {
          switch (t) {
            case H:
              e === k
                ? this.MCIDCallTimedOut !== i && (this.MCIDCallTimedOut = k)
                : (this.MCIDCallTimedOut = e);
              break;
            case E:
              e === k
                ? this.AnalyticsIDCallTimedOut !== i &&
                  (this.AnalyticsIDCallTimedOut = k)
                : (this.AnalyticsIDCallTimedOut = e);
              break;
            case D:
              e === k
                ? this.AAMIDCallTimedOut !== i && (this.AAMIDCallTimedOut = k)
      ...
      (a.isClientSideMarketingCloudVisitorID = function () {
        ...
        (a.idSyncByURL = function (t) {
          ...
          if (
            ...
            ("string" == typeof o.dpid && o.dpid.length) ||
              (n = n || "Error: config.dpid is empty"),
            ("string" == typeof o.url && o.url.length) ||
          ...
          return (
            (r = m.za(["", t.dpid, t.dpuuid || ""], ",")),
            (t = ["ibs", i(t.dpid), "img", i(n), e.ttl, "", r]),
            o.P(t.join("|")),
            o.q(),
            "Successfully queued"
          );
        ...
        (a.idSyncByDataSource = function (t) {
          return t === Object(t) &&
            "string" == typeof t.dpuuid &&
            t.dpuuid.length
            ? ((t.url =
                "//dpm.demdex.net/ibs:dpid=" + t.dpid + "&dpuuid=" + t.dpuuid),
              a.idSyncByURL(t))
        ...
        (a._getCookieVersion = function (t) {
          return (
            (t = t || a.cookieRead(a.cookieName)),
            (t = n.fa.exec(t)) && 1 < t.length ? t[1] : null
          );
        }),
      ...
      if (
        ((N[A] = i),
        (N[t] = i),
        w && "object" == (void 0 === w ? "undefined" : _typeof(w)))
      ) {
    ...
    function setup(t, e) {
      ...
      o.addEventListener("play", function () {
        n ||
          ((0, _debug.log)("Sending play event"),
          (n = !0),
          (s.events = "event4,event2,event27,event84=0,event85=186,event86"),
          s.t());
      }),
        o.addEventListener("ended", function () {
          r ||
            ((0, _debug.log)("Sending ended event"),
            (r = !0),
            (s.events = "event4,event2,event28"),
            s.t());
        }),
        ...
        (0, _debug.log)("Setting up omniture " + t),
        (s = s_gi(t)),
        (window.visitor = Visitor.getInstance(
          "A65F776A5245B01B0A490D44@AdobeOrg",
          { trackingServer: "an.mlb.com", trackingServerSecure: "ans.mlb.com" }
        )),
        (function () {
          function t() {
            e.aa = n;
        ...
        (s.socialPlatforms = new Function(
          "a",
          "var s=this,g,K,D,E,F;g=s.referrer?s.referrer:document.referrer;g=g.toLowerCase();K=s.split(s.socPlatList,'|');for(var i=0;i<K.length;i++){D=s.split(K[i],'>');if(g.indexOf(D[0])!=-1){if(a){s[a]=D[1];}}}"
        )),
        ...
        (s.getPageVisibility = new Function(
          "",
          "var s=this;if(s.getVisitStart()){s.Util.cookieWrite('s_pvs','');s.Util.cookieWrite('s_tps','');}if(s.Util.cookieRead('s_pvs')&&s.pvt<1){if(parseInt(s.Util.cookieRead('s_pvs'))<=parseInt(s.Util.cookieRead('s_tps'))){s.pve=s.pvel.split(',');s.events=s.apl(s.events,s.pve[0]+'='+(parseInt(s.Util.cookieRead('s_pvs'))),',',2);s.Util.cookieWrite('s_pvs','');s.events=s.apl(s.events,s.pve[1]+'='+(parseInt(s.Util.cookieRead('s_tps'))),',',2);s.Util.cookieWrite('s_tps','');s.events=s.apl(s.events,s.pve[2],',',2);}}s.pvi=setInterval(s.pvx,1000);s.wpvi=setInterval(s.wpvc,5000);"
        )),
        (s.gbp = new Function(
          "",
          "if('hidden'in document){return null;}var bp=['moz','ms','o','webkit'];for(var i=0;i<bp.length;i++){var p=bp[i]+'Hidden';if(p in document){return bp[i];}}return null;"
        )),
        (s.hp = new Function(
          "p",
        ...
        (s.pvx = new Function("", "var s=this;s.pvt+=1;")),
        (s.wpvc = function () {
          var t = Date.now();
          s.Util.cookieWrite("s_tps", Math.ceil((t - s.totalTime) / 1e3)),
            s.Util.cookieWrite("s_pvs", s.pvt);
        }),
        document.addEventListener("visibilitychange", function (t) {
          document.hidden
            ? ((s.visibility = !1), clearTimeout(s.pvi))
            : ((s.visibility = !0), (s.pvi = setInterval(s.pvx, 1e3)));
        }),
        ...
        (s.getVisitStart = new Function(
          "c",
          "var s=this,v=1,t=new Date;t.setTime(t.getTime()+1800000);if(s.c_r(c)){v=0}if(!s.c_w(c,1,t)){s.c_w(c,1,0)}if(!s.c_r(c)){v=0}return v;"
        )),
        (s.getLoadTime = new Function(
          "",
          "{if(!window.s_loadT){var b=new Date().getTime(),o=window.performance?performance.timing:0,a=o?o.requestStart:window.inHeadTS||0;s_loadT=a?Math.round((b-a)/100):''}return s_loadT}"
        )),
        (0, _device.isMobile)()
          ? (s.prop15 = "Mobile: ")
          : (0, _device.isTablet)()
      ...
      (s.prop15 +=
        ...
        (window.innerHeight || document.documentElement.clientHeight) >= a
          ? "Portrait"
          : "Landscape")),
        (s.pageName = "Major League Baseball: Multimedia: embedVideo"),
        (s.currencyCode = "USD"),
        (s.prop11 = "Dynamic Page View"),
        (s.prop13 = "Major League Baseball: Multimedia: embedVideo"),
        (s.eVar13 = "Streamable Embedded Video Player"),
        (s.prop22 = s.Util.cookieRead("ipid")
          ? s.Util.cookieRead("ipid")
          : null),
        (s.prop25 = e.fileid + "|" + e.filetype),
        (s.prop26 = "html5"),
        (s.prop27 = "Streamable Embedded Video Player"),
        (s.prop28 = "1.0"),
        (s.eVar28 = e.fileid + "|" + e.filetype),
        (s.prop29 = "Progressive Download"),
        (s.prop30 = e.title),
        (s.prop32 = e.filemeta1),
        (s.prop33 = e.filemeta2),
        (s.prop34 = e.filemeta3),
        (s.prop35Date = new Date()),
        (s.prop35 =
          s.prop35Date.getUTCMonth() +
          1 +
          "/" +
          s.prop35Date.getUTCDate() +
          "/" +
          s.prop35Date.getUTCFullYear() +
          " " +
          (s.prop35Date.getUTCHours() - 4) +
          ":" +
          s.prop35Date.getUTCMinutes() +
          ":" +
          s.prop35Date.getUTCSeconds()),
        (s.prop38 = s.getTimeParting("n", "-5")),
        (s.prop43 = "Most Popular"),
        (s.prop48 = s.getNewRepeat(30, "s_getNewRepeat")),
        (s.eVar48 = "Major League Baseball: Multimedia: embedVideo"),
        (s.prop49 = (0, _device.extractDomain)((0, _device.getPageURL)())),
        (s.eVar49 = (0, _device.extractDomain)((0, _device.getPageURL)())),
        (s.prop52 = "Major League Baseball: Multimedia: embedVideo"),
        (s.prop53 = s.getPercentPageViewed()),
        (s.prop54 = e.autoplay ? "System Generated" : "User Generated"),
        (s.eVar55 = navigator.userAgent),
        (s.eVar56 = (0, _device.getPageURL)()),
        (s.prop64 = "D=s_vi"),
        (s.eVar64 = "D=s_vi"),
        (s.prop66 = s.getLoadTime()),
      ...
      (s.trackingServer = "an.mlb.com"),
        ...
        (s.doPlugins = function (t) {
          t.loadModule("Media"),
            (t.Media.autoTrack = !1),
            (t.Media.trackWhilePlaying = !0),
            (t.Media.trackVars = "None"),
            (t.Media.trackEvents = "None"),
            (t.maxDelay = "3000");
        });
    }
    function AppMeasurement() {
      ...
      (t.P = function (t) {
            ...
            (r = "+~!*()'".substring(n, n + 1)),
              0 <= e.indexOf(r) &&
                (e = t.replace(
                  e,
                  r,
                  "%" + r.charCodeAt(0).toString(16).toUpperCase()
                ));
          return e;
        }),
            ...
            return "[[B]]" !=
              (e =
                0 > r
                  ? ""
                  : t.unescape(
                      n.substring(r + 2 + e.length, 0 > i ? n.length : i)
                    ))
              ? e
              : "";
          }),
          ...
          function (e, n, r) {
            ...
            return (
              ...
              r &&
                ...
                "NONE" != a &&
                ((i = "" != n ? parseInt(a || 0) : -60)
                  ? (r = new Date()).setTime(r.getTime() + 1e3 * i)
                  : 1 == r &&
                    ((i = (r = new Date()).getYear()),
                    r.setYear(i + 5 + (1900 > i ? 1900 : 0)))),
              e && "NONE" != a
                ? ((t.d.cookie =
                    t.escape(e) +
                    "=" +
        ...
        (t.ia = function (e, n, r) {
          ...
          if ((a || (a = t.d.webkitVisibilityState), a && "prerender" == a)) {
            if (!t.ja)
              for (t.ja = 1, r = 0; r < s.length; r++)
                t.d.addEventListener(s[r], function () {
                  var e = t.d.visibilityState;
                  e || (e = t.d.webkitVisibilityState),
                    "visible" == e && ((t.ja = 0), t.delayReady());
                });
            (i = 1), (o = 0);
          } else r || (t.p("_d") && (i = 1));
          return (
            i &&
              (t.K.push({ m: e, a: n, t: o }),
              t.ja || setTimeout(t.delayReady, t.maxDelay)),
            i
          );
        }),
              ...
              t.lightProfileID
                ...
                : ((r = t.g),
                  (t.pe || t.linkType) &&
                    ...
                    t.pe &&
                      ((o =
                        t.pe.substring(0, 1).toUpperCase() + t.pe.substring(1)),
                      t[o] && ((s = t[o].Mb), (i = t[o].Lb)))),
                  s && (s = "," + s + "," + t.G.join(",") + ","),
                  i && s && (s += ",events,")),
              n && (n = "," + n + ","),
              i = 0;
              ...
              if (
                ...
                if (((c = !1), f))
                  for (s = 0; s < f.length; s++)
                    a.substring(0, f[s].length) == f[s] && (c = !0);
                if (
                  !c &&
                  ("" == l && (l += "&" + e + "."),
                  (s = n[a]),
                  ...
                  if (0 < (c = a.indexOf(".")))
                    ...
                    if (
                      "retrieveLightData" == i &&
                      0 > o.indexOf(".contextData.")
                    )
                      switch (
                        ((c = a.substring(0, 4)), (u = a.substring(4)), a)
                      ) {
                        case "transactionID":
                          a = "xact";
                          break;
              ...
              : ((e = t.g),
                (t.pe || t.linkType) &&
                  ...
                  t.pe &&
                    ((o =
                      t.pe.substring(0, 1).toUpperCase() + t.pe.substring(1)),
                    t[o] && ((f = t[o].Mb), (p = t[o].Lb)))),
                f && (f = "," + f + "," + t.G.join(",") + ","),
                p && ((p = "," + p + ","), f && (f += ",events,")),
                t.events2 && (d += ("" != d ? "," : "") + t.events2)),
            t.visitor && t.visitor.getCustomerIDs)
          ) {
            if (((o = n), (a = t.visitor.getCustomerIDs())))
              for (r in a)
                Object.prototype[r] ||
                  ("object" ==
                    (void 0 === (i = a[r]) ? "undefined" : _typeof(i)) &&
                    (o || (o = {}),
                    i.id && (o[r + ".id"] = i.id),
                    i.authState && (o[r + ".as"] = i.authState)));
            o && (l += t.r("cid", o));
          }
          for (
            t.AudienceManagement &&
              t.AudienceManagement.isReady() &&
              (l += t.r("d", t.AudienceManagement.getEventCallConfigParams())),
              r = 0;
            r < e.length;
            r++
          ) {
            if (
              ...
              switch (o) {
                ...
                case "retrieveLightData":
                  t.retrieveLightProfiles && (l += t.r("mts", t[o], f, o)),
                    (a = "");
                  break;
                default:
                  t.La(s) &&
              ...
              a &&
                (l +=
                  ...
                  o +
                  "=" +
                  ("pev" != o.substring(0, 3) ? t.escape(a) : a));
            }
            "pev3" == o && t.e && (l += t.e);
          }
          return l;
        ...
        (t.D = function (t) {
          var e = t.tagName;
          return "undefined" != "" + t.Rb ||
            ("undefined" != "" + t.Hb && "HTML" != ("" + t.Hb).toUpperCase())
            ? ""
            : ("SHAPE" == (e = e && e.toUpperCase ? e.toUpperCase() : "") &&
                (e = ""),
              e &&
                (("INPUT" == e || "BUTTON" == e) && t.type && t.type.toUpperCase
                  ? (e = t.type.toUpperCase())
                  : !e && t.href && (e = "A")),
              e);
        }),
        (t.Ha = function (t) {
          ...
          return (
            ...
            a &&
              (0 > n || (0 <= r && n > r) || (0 <= i && n > i)) &&
              ((r =
                t.protocol && 1 < t.protocol.length
                  ? t.protocol
                  : o.protocol
                  ? o.protocol
                  : ""),
              ...
              (a =
                (r ? r + "//" : "") +
                (t.host ? t.host : o.host ? o.host : "") +
                ("/" != a.substring(0, 1)
                  ? o.pathname.substring(0, 0 > n ? 0 : n) + "/"
                  : "") +
                a)),
            a
          );
        ...
        (t.L = function (e) {
          ...
          return i &&
            ...
            !e.href ||
            ("A" != i && "AREA" != i) ||
            (r && n && !(0 > n.toLowerCase().indexOf("javascript")))
              ? r
                ? ((o = t.replace(
                    t.replace(
                      t.replace(t.replace("" + r, "\r", ""), "\n", ""),
                      "\t",
                      ""
                    ),
                    " ",
                ...
                ? (e.value
                  ...
                  (a = 3))
                : "IMAGE" == i && e.src && (o = e.src)
              : (o = t.Ha(e)),
            o)
            ? { id: o.substring(0, 100), type: a }
            : 0;
        }),
        (t.Pb = function (e) {
          for (var n = t.D(e), r = t.L(e); e && !r && "BODY" != n; )
          ...
          if (
            ...
            if (t.trackDownloadLinks && t.linkDownloadFileTypes)
              for (
                ...
                (l = i[o]) &&
                  u.substring(u.length - (l.length + 1)) == "." + l &&
                  (s = "d");
            if (
              ...
              t.Ka(u) &&
                (t.linkInternalFilters ||
                  (t.linkInternalFilters = e.location.hostname),
                (i = 0),
                t.linkExternalFilters
                  ? ((i = t.linkExternalFilters.toLowerCase().split(",")),
                    (f = 1))
                  : t.linkInternalFilters &&
          ...
          (t.linkObject = a),
            ...
            (t.trackClickMap || t.trackInlineStats) &&
              ...
              a &&
                ...
                (a = a.sourceIndex),
                s || ((s = t.pageURL), (c = 0)),
                e.s_objectID && ((r.id = e.s_objectID), (a = r.type = 1)),
                s &&
                  r &&
                  r.id &&
                  n &&
                  (t.e =
                    "&pid=" +
                    t.escape(s.substring(0, 255)) +
                    (c ? "&pidt=" + c : "") +
                    "&oid=" +
                    t.escape(r.id.substring(0, 100)) +
                    (r.type ? "&oidt=" + r.type : "") +
                    "&ot=" +
                    n +
                    (a ? "&oi=" + a : ""))));
        ...
        (t.zb = function () {
          ...
          if (
            (n &&
              ...
              (e = 1)),
            t.abort && (e = 0),
            t.trackClickMap || t.trackInlineStats || t.ActivityMap)
          ) {
            (n = {}), (r = 0);
            var o,
              a,
              s,
              c = (u = t.cookieRead("s_sq")) ? u.split("&") : 0,
              u = 0;
            if (c)
            ...
            for (s in ((i = t.account.split(",")), (o = {}), t.contextData))
              s &&
                ...
                ((o[s] = t.contextData[s]), (t.contextData[s] = ""));
            if (((t.e = t.r("c", o) + (t.e ? t.e : "")), e || t.e)) {
              ...
              if ((e || (r = 1), r)) {
                ...
                !e &&
                  t.e &&
                  ((u = t.escape(i.join(",")) + "=" + t.escape(t.e)), (o = 1)),
                n))
                  !Object.prototype[a] &&
                    0 < o &&
                    0 < n[a].length &&
        ...
        (t.Ab = function () {
          if (!t.Kb) {
            ...
            if (
              o.setUTCDate &&
              ((u = "1.3"), (0).toPrecision && ((u = "1.5"), (o = []).forEach))
            ) {
              (u = "1.6"), (n = 0), (e = {});
              try {
        ...
        (t.loadModule = function (n, r) {
          var i = t.Q[n];
          if (!i) {
            (i = e["AppMeasurement_Module_" + n]
              ? new e["AppMeasurement_Module_" + n](t)
              : {}),
              (t.Q[n] = t[n] = i),
              (i.cb = function () {
                return i.hb;
              ...
              (i.ib = function (e) {
                (i.hb = e) &&
                  ((t[n + "_onLoad"] = e),
                  t.ia(n + "_onLoad", [t, i], 1) || e(t, i));
              });
            try {
              Object.defineProperty
                ? Object.defineProperty(i, "onLoad", { get: i.cb, set: i.ib })
                : (i._olc = 1);
            } catch (t) {
              i._olc = 1;
            }
          ...
          r &&
            ((t[n + "_onLoad"] = r), t.ia(n + "_onLoad", [t, i], 1) || r(t, i));
        }),
        (t.p = function (e) {
          var n, r;
          for (n in t.Q)
            if (
              !Object.prototype[n] &&
              (r = t.Q[n]) &&
              (r._olc && r.onLoad && ((r._olc = 0), r.onLoad(t, r)),
              r[e] && r[e]())
            )
              return 1;
          return 0;
        ...
        (t.ub = function (t) {
          ...
          if (
            ...
            (r = 0),
            "http://" ==
            (i = (e = e.substring(0, n)).toLowerCase()).substring(0, 7)
              ? (r += 7)
              : "https://" == i.substring(0, 8) && (r += 8),
            0 < (n = i.indexOf("/", r)) &&
              ((i = i.substring(r, n)),
              (o = e.substring(n)),
              (e = e.substring(0, n)),
              0 <= i.indexOf("google")
                ...
                : 0 <= i.indexOf("yahoo.co") && (s = ",p,ei,"),
              s && a))
          ) {
            if ((t = a.split("&")) && 1 < t.length) {
              for (r = 0; r < t.length; r++)
                0 < (n = (i = t[r]).indexOf("=")) &&
                0 <= s.indexOf("," + i.substring(0, n) + ",")
                  ? (c += (c ? "&" : "") + i)
                  : (u += (u ? "&" : "") + i);
              c && u ? (a = c + "&" + u) : (u = "");
            }
            t =
              e +
              (0 < (n = 253 - (a.length - u.length) - e.length)
                ? o.substring(0, n)
                : "") +
              "?" +
              a;
        ...
        (t.isReadyToTrack = function () {
          var e,
            ...
            a = t.visitor;
          return (
            t.ea || t.I || (t.$a(t.kb) ? (t.I = !0) : (t.ea = !0)),
            !(t.ea && !t.I) &&
              (a &&
                a.isAllowed() &&
                (t.ca ||
                  ...
                  !a.getMarketingCloudVisitorID ||
                  ((t.ca = !0),
                  (t.marketingCloudVisitorID = a.getMarketingCloudVisitorID([
                    t,
                    t.gb,
                  ])),
                  t.marketingCloudVisitorID && (t.V = !0)),
                t.fa ||
                  t.visitorOptedOut ||
                  !a.isOptedOut ||
                  ((t.fa = !0),
                  (t.visitorOptedOut = a.isOptedOut([t, t.lb])),
                  t.visitorOptedOut != n && (t.W = !0)),
                t.Z ||
                  t.analyticsVisitorID ||
                  !a.getAnalyticsVisitorID ||
                  ((t.Z = !0),
                  (t.analyticsVisitorID = a.getAnalyticsVisitorID([t, t.Wa])),
                  t.analyticsVisitorID && (t.S = !0)),
                t.ba ||
                  t.audienceManagerLocationHint ||
                  !a.getAudienceManagerLocationHint ||
                  ((t.ba = !0),
                  (t.audienceManagerLocationHint =
                    a.getAudienceManagerLocationHint([t, t.Ya])),
                  t.audienceManagerLocationHint && (t.U = !0)),
                t.aa ||
                  t.audienceManagerBlob ||
                  !a.getAudienceManagerBlob ||
                  ((t.aa = !0),
                  (t.audienceManagerBlob = a.getAudienceManagerBlob([t, t.Xa])),
                  t.audienceManagerBlob && (t.T = !0)),
                (o = t.ca && !t.V && !t.marketingCloudVisitorID),
                (a = t.Z && !t.S && !t.analyticsVisitorID),
                (e = t.ba && !t.U && !t.audienceManagerLocationHint),
                (r = t.aa && !t.T && !t.audienceManagerBlob),
                (i = t.fa && !t.W),
                (o = !(o || a || e || r || i))),
              t.da || t.H || (t.Za(t.xa) ? (t.H = !0) : (t.da = !0)),
              t.da && !t.H && (o = !1),
              o)
          );
        }),
        (t.o = n),
        (t.u = 0),
        (t.callbackWhenReadyToTrack = function (e, r, i) {
          var o;
          ((o = {}).pb = e),
            (o.ob = r),
            (o.mb = i),
        ...
        (t.eb = function (e) {
          var r,
            ...
            a = n;
          if (!t.isReadyToTrack()) {
            if (((r = []), e != n)) for (i in ((o = {}), e)) o[i] = e[i];
            return (
              (a = {}),
              t.Ua(a, !0),
              r.push(o),
              r.push(a),
              t.callbackWhenReadyToTrack(t, t.track, r),
              !0
            );
          }
          return !1;
        ...
        (t.t = t.track =
          function (n, r) {
            ...
            t.visitor &&
              t.visitor.getAuthState &&
              (t.authState = t.visitor.getAuthState()),
              t.p("_s"),
              t.eb(n) ||
                (r && t.R(r),
                n && ((i = {}), t.Ua(i, 0), t.R(n)),
                  ...
                  t.account &&
                    (t.abort ||
                      (t.visitor &&
                        ...
                        t.visitor.getSupplementalDataID &&
                      ...
                      t.trackOffline &&
                        !t.timestamp &&
                        (t.timestamp = Math.floor(o.getTime() / 1e3)),
                      (o = e.location),
                      t.pageURL || (t.pageURL = o.href ? o.href : o),
                      t.referrer || t.Va || (t.referrer = a.document.referrer),
                      (t.Va = 1),
                      (t.referrer = t.ub(t.referrer)),
                      t.p("_g")),
                    t.zb() &&
                      !t.abort &&
                      (t.Ab(),
        ...
        (t.Fb = function (e, n) {
          ...
          i
            ? t.trackingServerSecure && t.ssl && (i = t.trackingServerSecure)
            : (s ||
                (0 <= (i = (s = t.account).indexOf(",")) &&
                  (s = s.substring(0, i)),
                (s = s.replace(/[^A-Za-z0-9]/g, ""))),
              r || (r = "2o7.net"),
              (o = o ? ("" + o).toLowerCase() : "d1"),
              "2o7.net" == r &&
                ("d1" == o ? (o = "112") : "d2" == o && (o = "122"), (a = "")),
              (i = s + "." + o + "." + a + r)),
            (r = t.ssl ? "https://" : "http://"),
            (o =
            ...
            (r +=
              ...
              e +
              "?AQB=1&ndh=1&pf=1&" +
              (o ? "callback=s_c_il[" + t._in + "].doPostbacks&et=1&" : "") +
              n +
              "&AQE=1"),
            t.bb(r),
            t.sb(r),
        ...
        (t.ra = function () {
          var n = !0;
          return (
            (t.trackOffline && t.offlineFilename && e.localStorage && e.JSON) ||
              (n = !1),
            n
          );
        }),
      ...
      for (
        o && "y" == o.x
          ...
          t.Ib = function (r) {
            ...
            if (
              (t.fb() &&
                ...
                i ||
                  "undefined" == typeof XDomainRequest ||
                  ((i = new XDomainRequest()), (o = 2)),
                i &&
                  ((t.AudienceManagement && t.AudienceManagement.isReady()) ||
                    0 != t.usePostbacks) &&
                  (t.Y ? (i.Ba = !0) : (i = 0))),
              !i && t.Sa && (r = r.substring(0, 2047)),
              !i &&
                t.d.createElement &&
                (0 != t.usePostbacks ||
                  (t.AudienceManagement && t.AudienceManagement.isReady())) &&
                ...
                ("async" in i) &&
                ((a =
                  (a = t.d.getElementsByTagName("HEAD")) && a[0]
                    ? a[0]
                    : t.d.body)
              ...
              (i.onload = i.va =
                function () {
                  if (
                    (t.ab(r), i.Da(), t.rb(), t.ga(), (t.q = 0), t.ka(), i.Ba)
                  ) {
                    i.Ba = !1;
                    try {
              ...
              (i.onabort =
                ...
                i.Ga =
                  function () {
                    i.Da(),
                      (t.trackOffline || t.qa) && t.q && t.i.unshift(t.qb),
                      (t.q = 0),
                      t.ma > t.N && t.Pa(t.i),
                      t.ga(),
                      t.ua(500);
              ...
              var s = r.indexOf("?");
              (a = r.substring(0, s)),
                (s = (s = r.substring(s + 1)).replace(
                  /&callback=[a-zA-Z0-9_.\[\]]+/,
                  ""
                )),
                1 == o
                  ? (i.open("POST", a, !0), i.send(s))
                  : 2 == o && (i.open("POST", a), i.send(s));
            } else if (((i.src = r), 3 == o)) {
              if (t.Ma)
                try {
                  a.removeChild(t.Ma);
            ...
            (i.F = setTimeout(function () {
              ...
              (t.qb = r),
              (t.B = e["s_i_" + t.replace(t.account, ",", "_")] = i),
              ((t.useForcedLinkTracking && t.J) || t.A) &&
                (t.forcedLinkTrackingTimeout ||
                  (t.forcedLinkTrackingTimeout = 250),
                (t.ha = setTimeout(t.ga, t.forcedLinkTrackingTimeout)));
          },
          t.rb = function () {
            if (t.ra() && !(t.Na > t.N))
              try {
          ...
          t.Pa = function (n) {
            if (t.ra()) {
              t.Ra();
              try {
                e.localStorage.setItem(t.pa(), e.JSON.stringify(n)),
                  (t.N = t.C());
              } catch (t) {}
            }
          },
          ...
          t.setTagContainer = function (e) {
            ...
            for (t.Jb = e, n = 0; n < t._il.length; n++)
              if ((r = t._il[n]) && "s_l" == r._c && r.tagContainerName == e) {
                ...
                if (r.tq) for (n = 0; n < r.tq.length; n++) t.track(r.tq[n]);
                r.s = t;
                break;
              }
          },
          t.Util = {
            ...
            getQueryParam: function (n, r, i) {
              var o;
              return (
                r || (r = t.pageURL ? t.pageURL : e.location),
                i || (i = "&"),
                n &&
                r &&
                0 <= (o = (r = "" + r).indexOf("?")) &&
                0 <=
                  (o = (r = i + r.substring(o + 1) + i).indexOf(i + n + "=")) &&
                (0 <=
                  (o = (r = r.substring(o + i.length + n.length + 1)).indexOf(
                    i
                  )) && (r = r.substring(0, o)),
                0 < r.length)
                  ? t.unescape(r)
        ...
        76 > r && (t.g.push("prop" + r), t.O.push("prop" + r)),
          t.g.push("eVar" + r),
          t.O.push("eVar" + r),
          6 > r && t.g.push("hier" + r),
          4 > r && t.g.push("list" + r);
      (r =
        ...
        (t.g = t.g.concat(r)),
        (t.G = t.G.concat(r)),
        (t.ssl = 0 <= e.location.protocol.toLowerCase().indexOf("https")),
        (t.charSet = "UTF-8"),
        (t.contextData = {}),
      ...
      try {
        if (((t.Sa = !1), navigator)) {
          ...
          ("Microsoft Internet Explorer" == navigator.appName ||
            0 <= s.indexOf("MSIE ") ||
            (0 <= s.indexOf("Trident/") && 0 <= s.indexOf("Windows NT 6"))) &&
            (t.Sa = !0);
        }
      } catch (t) {}
      (t.ga = function () {
        t.ha && (e.clearTimeout(t.ha), (t.ha = n)),
          t.l && t.J && t.l.dispatchEvent(t.J),
          t.A &&
            ("function" == typeof t.A
              ? t.A()
              : t.l && t.l.href && (t.d.location = t.l.href)),
          (t.l = t.J = t.A = 0);
      }),
        (t.Qa = function () {
          (t.b = t.d.body),
                  ...
                  if (
                    ...
                    if (t.Ca) {
                      if (!t.useForcedLinkTracking)
                        return (
                          t.b.removeEventListener("click", t.v, !0),
                          void (t.Ca = t.useForcedLinkTracking = 0)
                        );
                    ...
                    try {
                      if (
                        ...
                        if (
                          (t.la && (clearTimeout(t.la), (t.la = 0)),
                          (t.la = setTimeout(function () {
                            t.M == c && (t.M = 0);
                          }, 1e4)),
                          (o = t.Ia()),
                          t.track(),
                          o < t.Ia() && t.useForcedLinkTracking && n.target)
                        ) {
                          for (
                            a = n.target;
                            a &&
                ...
                t.b && t.b.attachEvent
                  ...
                  : t.b &&
                    ...
                    (navigator &&
                      ...
                      t.b.addEventListener("click", t.v, !0)),
                    t.b.addEventListener("click", t.v, !1)))
              : setTimeout(t.Qa, 30);
        }),
        t.Qa(),
    ...
    function s_gi(t) {
        ...
        for (n = 0; !c && n < a.length; ) {
          if ("s_c" == (e = a[n])._c && (e.account || e.oun))
            if (e.account && e.account == t) c = 1;
              ...
              for (
                r = e.account ? e.account : e.oun,
                  r = e.allAccounts ? e.allAccounts : r.split(","),
                  i = 0;
                i < s.length;
                i++
              )
      ...
      return (
        c || (e = new AppMeasurement()),
        e.setAccount ? e.setAccount(t) : e.sa && e.sa(t),
        e
      );
    }
    function s_pgicq() {
      ...
      if (i)
        for (t = 0; t < i.length; t++)
          (n = s_gi((e = i[t]).oun)).setAccount(e.un),
            n.setTagContainer(e.tagContainerName);
      r.s_giq = 0;
    }
    (Visitor.getInstance = function (t, e) {
      ...
      if ((0 > t.indexOf("@") && (t += "@AdobeOrg"), i))
        for (r = 0; r < i.length; r++)
          if ((n = i[r]) && "Visitor" == n._c && n.marketingCloudOrgID == t)
            return n;
